...
class DereenaUI:
    def __init__(self, root):
        ...
        self.printsvg = ttk.Button(self.controls_frame, text="Open Inkscape", command=self.open_inkscape)
    ...
    def upload_image(self):
        ...
        if file_path:
            ...
            self.captured_image = self.resize_image(self.captured_image, (640, 480))
    ...
    def capture_image(self):
        if self.cap is not None:
            ...
            if ret:
                ...
                # Resize the captured image to fit the canvas
                self.captured_image = self.resize_image(self.captured_image, (640, 480))
    ...
    def open_inkscape(self):
        # Replace the path below with the actual path to the Inkscape executable on your system
        inkscape_path = "C:/Program Files/Inkscape/inkscape.exe"

        try:
            subprocess.run([inkscape_path])
        except FileNotFoundError:
            messagebox.showerror("Error", "Inkscape not found. Please install Inkscape and try again.")
